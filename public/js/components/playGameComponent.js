...
let playGameComponent = Vue.component("play-game-component", {
    props: ["name", "code", "mode", "socket", "socketid", "invalid"],
    data: function () {
        return {
    ...
    template:
        ...
        <div class="row">
            <button type="input" v-on:click.prevent="endGameEvent()" class="btn btn-warning mr-1 col-3 col-lg-2 col-lg-1" id="volver" name="volver"><i class="fas fa-arrow-left"></i>&nbsp;Volver</button>
        </div>    
        <div id="maingame">
